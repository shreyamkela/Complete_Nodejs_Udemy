...
app.use((req, res, next) => { // Maintainance middleware
    ...
    // Note - Call to the public route should be after the maintainence.hbs call as express executes in the order in which app.use is used in the code. If app.use(express.static(__dirname + '/public')); is above maintainance.hbs call, then public folder will still be served even if all the other handlers are not, when site is under maintainence. 
