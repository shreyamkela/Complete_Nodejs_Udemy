...
describe('Utils', () => { // Combines all the tests described inside, under a heading 'Utils'. Functionality of Mocha. To make the test results more readable. It wraps up tests under blocks
    ...
    describe('#some value', () => { // Nested describe function under Utils describe - Combines all the tests described inside, under a heading 'some value'. # denotes a sort of numbering convention
